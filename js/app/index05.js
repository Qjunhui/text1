...
SongManager.prototype={
    ...
    bindEvents:function () {
        ...
        //事件委托
        //事件名称的命名空间
        self.$containerString.on("click.addSong","#btnAddSong",function () {
            ...
            $txtSongName.val("");
            $txtSingerName.val("");
        }).on("click.deleteSong",".btn-delete",function () {
            // console.log(this);   this：删除按钮
           self.deleteSong(this);
        })
